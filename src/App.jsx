...
export default function App() {
	const questions = [
		{
			questionText: 'Where is the capital of France?',
			answerOptions: [
		...
		{
			questionText: 'Which company manufactures the iPhone?',
			answerOptions: [
		...
		{
			questionText: 'How many Harry Potter books have been written so far?',
			answerOptions: [
		...
		<div className='app'>
			{showScore ? (
				...
				<>
					...
					<div className='answer-section ml-10' style={{ textAlign: 'center' }}>
